...
gsap.registerPlugin(ScrollTrigger);
    ...
    ScrollTrigger.batch("h2", {onEnter : batch => gsap.from(batch, {duration: 0.6, x: 50, opacity:0, ease: Power3.out,})})
    ScrollTrigger.batch("p", {onEnter : batch => gsap.from(batch, {delay: 0.3, duration: 0.5, opacity:0, ease: Power3.out,})})
    ScrollTrigger.batch("a", {onEnter : batch => gsap.from(batch, {delay: 0.3, duration: 0.5, opacity:0, ease: Power3.out,})})
    //Text Animations
